...
cilk: mmio.c coo2csc.c mergesort.c utils.c cilk_version.c
	$(CC) $(CFLAGS) -c mmio.c coo2csc.c mergesort.c utils.c cilk_version.c
	$(CC) mmio.o coo2csc.o mergesort.o utils.o cilk_version.o -o cilk_version -fcilkplus -lpthread
